...
<body class="bg-slate-900">
    <form action="{{ route('conclusao.enviar') }}" method="post" class="flex flex-col items-center py-64">
        @csrf
        <div class="flex flex-col bg-white border rounded-lg shadow-md w-full md:max-w-6xl dark:border-gray-700 dark:bg-gray-800">
